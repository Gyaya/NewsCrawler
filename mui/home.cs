...
namespace mui
{
    class home
    {
        public string path = "C:\\News\\Sina\\";
        public string url="http://news.sina.com.cn/society/";
        public List<string> list = new List<string>();
        public List<string> list_m = new List<string>();
        public int year,month,day1,day2;
        const int pages = 20;
        public bool con = true;
        public bool scan_ok = false;
        public bool downlaod_ok = false;
        ...
        //传参
        public void Get_Value(string y, string m, string d1, string d2)
        {
            year=int.Parse(y);
            month=int.Parse(m);
            day1=int.Parse(d1);
        ...
        //得到固定格式的日期
        public string Get_Date(int day,bool y)
        {
        ...
        //匹配url
        public List<string> Match(string url, string regex, ref bool success)
        {
            int i;
            string content = "";
