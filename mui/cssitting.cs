...
namespace mui
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public cssitting()
        {
            ...
            this.themes.Add(new Link { DisplayName = "bing", Source = new Uri("bing.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "snow", Source = new Uri("Snow.xaml", UriKind.Relative) });
